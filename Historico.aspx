  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <ul class="navbar-nav" style="margin-right: 32px;">
        ...
        <li class="nav-item sections">
          <a class="nav-link active" href="Historico.aspx">HIST&Oacute;RICO</a>
        </li>
      </ul>
    </div>
  </div>
...
<!-- HEADER -->
  ...
  <h1>Hist&oacute;rico Convocatoria 2023 GII </h1>
  <p class="info" style="font-size: 16px; color: #696969; margin-top: 24px;">En abril de 2022 dio inicio la organizaci&oacute;n de la Convocatoria 2023.</p>
  <p class="info" style="margin-top: 32px; margin-bottom: 32px;">En abril de 2022 iniciaron los trabajos de organizaci&oacute;n para convocar a las y los acad&eacute;micos del IIUNAM y otras entidades acad&eacute;micas de la UNAM interesadas/os en participar en la Convocatoria GII 2023. El proceso culmin&oacute; en febrero de 2023 con el inicio formal de los cuatro proyectos aprobados en dos ETEI. Para esta convocatoria los ETEI considerados fueron Ciudades Inteligentes y Nexo Agua-Energ&iacute;a-Ambiente-Seguridad Alimentaria.</p>
