...
<body>
<!-- HEADER -->
<nav class="navbar fixed-top navbar-expand-lg justify-content-end bg-gradient">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <ul class="navbar-nav" style="margin-right: 32px;">
        ...
        <li class="nav-item sections">
          <a class="nav-link active" href="Entidades.aspx">ENTIDADES PARTICIPANTES</a>
        </li>
        <li class="nav-item sections">
...
<!-- HEADER -->
  ...
  <div class="row" >
    <div class="col-md-6">
      <p class="info-name" style="margin-top: 24px; color: #474747; margin-bottom: 16px; "> Instituciones acad&eacute;micas participantes:</p>
    ...
    <div class="col-md-6">
      <p  class="info-name" style="margin-top: 24px; color: #474747; margin-bottom: 16px; "> Instituciones externas a la UNAM: </p>
