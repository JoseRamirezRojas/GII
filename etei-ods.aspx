...
<head>
    ...
    <link rel="stylesheet" href="css/etei-ods.css">
</head>
<body>
<!-- HEADER -->
...
<!-- HEADER -->
  ...
  <p class="info" style="font-size: 16px; color: #696969; margin-top: 24px;">Conoce los ODS implicados en el desarrollo de los cuatro proyectos aprobados en la convocatoria 2023.</p>
  <p class="info" style="margin-top: 24px;">Para la convocatoria GII 2023 se consideraron dos Ejes Tem&aacute;ticos Estrat&eacute;gicos de Investigaci&oacute;n (ETEI): Ciudades Inteligentes y Nexo Agua-Energ&iacute;a-Ambiente-Seguridad Alimentaria. Las propuestas de proyectos dentro de cada ETEI deb&iacute;an considerar temas suscritos dentro de los Objetivos de Desarrollo Sostenible (ODS) de la Organizaci&oacute;n de las Naciones Unidas (ONU).</p>
  <p class="info">Los ODS a considerar de manera directa y mayoritaria, as&iacute; como los que tienen impacto indirecto en las propuestas se muestran a continuaci&oacute;n.</p>
  <h1 style="margin-top: 40px; color: #027b00;">  ETEI: Ciudades Inteligentes </h1>
  <h3> ODS con relaci&oacute;n directa en el ETEI</h3>
  <p class="info" >ODS 3: Salud y bienestar. <br>
    ODS 6: Agua limpia y saneamiento. <br>
    ODS 7: Energ&iacute;a asequible y no contaminante. <br>
    ODS 8: Trabajo decente y crecimiento econ&oacute;mico.<br>
    ODS 9: Industria, innovaci&oacute;n e infraestructuras.<br>
    ODS 13: Acci&oacute;n por el clima.  <br>
    ODS 14: Vida submarina. <br>
    ODS 15: Vida de ecosistemas terrestres</p>
    <h3>ODS con impacto indirecto en el ETEI</h3>
  <p class="info" >ODS 1: Fin de la pobreza. <br>
    ODS 2: Hambre cero. <br>
    ODS 5: Igualdad de g&eacute;nero. <br>
    ODS 10: Reducci&oacute;n de desigualdades.<br></p>
    <h1 style="margin-top: 40px; color: #0067a0;">ETEI: Nexo Agua-Energ&iacute;a-Ambiente-Seguridad Alimentaria. </h1>
  <h3> ODS con relaci&oacute;n directa en el ETEI</h3>
  <p class="info">ODS 3: Salud y bienestar. <br>
    ODS 6: Agua limpia y saneamiento. <br>
    ODS 7: Energ&iacute;a asequible y no contaminante. <br>
    ODS 8: Trabajo decente y crecimiento econ&oacute;mico.<br>
    ODS 9: Industria, innovaci&oacute;n e infraestructuras.<br>
    ODS 11: Ciudades y comunidades inclusivos, seguros, resilientes y sostenibles.<br>
    ODS 12: Producci&oacute;n y consumo</p>
    <h3>ODS con impacto indirecto en el ETEI</h3>
  <p class="info">ODS 1: Fin de la pobreza. <br>
    ODS 2: Hambre cero. <br>
    ODS 5: Igualdad de g&eacute;nero. <br>
